...
public class FilePickerPlugin implements MethodChannel.MethodCallHandler, FlutterPlugin, ActivityAware {
    ...
    public void onMethodCall(final MethodCall call, final MethodChannel.Result rawResult) {
        ...
        boolean disableExternalSources = false;
        ...
        if (fileType == null) {
            ...
            if (arguments.containsKey("disableExternalSources")) {
                disableExternalSources = (boolean) arguments.get("disableExternalSources");
            }
        }
        ...
        if (fileType == "custom" && (allowedExtensions == null || allowedExtensions.length == 0)) {
            ...
            this.delegate.startFileExplorer(fileType, isMultipleSelection, withData, allowedExtensions, disableExternalSources, result);
        }
